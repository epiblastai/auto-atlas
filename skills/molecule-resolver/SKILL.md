...
description: Resolve chemical compound names, SMILES, or CIDs to canonical structures for SmallMoleculeSchema using auto_atlas.resolve_molecules(). Handles name cleanup, control label detection, PubChem/ChEMBL resolution, and SMILES canonicalization. Use when a dataset has small molecule perturbation columns.
---
